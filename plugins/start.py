...
<b><i>Uɴsᴜᴄᴄᴇssғᴜʟ</i> : <code>{unsuccessful}</code></b>"""
        ...
        msg = await message.reply("<b><i>Usᴇ Tʜɪs Cᴏᴍᴍᴀɴᴅ As ᴀ Rᴇᴘʟʏ ᴛᴏ Aɴʏ Tᴇʟᴇɢʀᴀᴍ Mᴇssᴀɢᴇ Wɪᴛʜoᴜᴛ Aɴʏ Sᴘᴀᴄᴇs.</i></b>")
...
async def cb_data(client: Client, query: CallbackQuery):
    if query.data == "about":
        buttons = [
            [InlineKeyboardButton("👨‍💻 Aᴅᴍɪɴ", url="https://myselfneon.github.io/neon/")],
            [
        ...
        await query.message.edit_text(
            text="<b>🤖 Aʙᴏᴜᴛ Tʜɪs Bᴏᴛ</b>\n\n<i>Tʜɪs ɪs ᴀ ᴄᴜsᴛᴏᴍ Tᴇʟᴇɢʀᴀᴍ Bᴏᴛ ᴍᴀᴅᴇ ʙʏ Aᴅᴍɪɴ 👨‍💻</i>",
            reply_markup=InlineKeyboardMarkup(buttons),
            disable_web_page_preview=True
        )
